...
[**Windows 다운로드**](https://github.com/mkyoon80-alt/xbar-control/releases/tag/v1.4.0) · [한국어 사용법](docs/usage.ko.md) · [검증 범위](docs/validation.md)
...
- Windows 시작 시 **트레이 아이콘으로 시작** 선택 가능. 더블클릭으로 창 열기, 우클릭으로 자동 적용 취소·종료.
- 일반 실행에서도 최소화하면 작업표시줄 대신 트레이로 이동.
...
기존 Windows 시작 옵션을 사용했다면 새 EXE를 관리자 권한으로 열고 **트레이 아이콘으로 시작**을 켜세요. 저장값을 유지하면서 새 실행 파일과 30초 대기 시간으로 갱신합니다. 트레이 모드 없이 갱신하려면 Windows 시작 옵션을 껐다 켜세요.
