    ...
    public static class StartupTask {
        ...
        public static string BuildXml(string executable,string sid) {
            ...
            using(var w=XmlWriter.Create(text,new XmlWriterSettings{OmitXmlDeclaration=true,Indent=true})) {
                ...
                w.WriteStartElement("Triggers"); w.WriteStartElement("LogonTrigger"); w.WriteElementString("Enabled","true"); w.WriteElementString("UserId",sid); w.WriteElementString("Delay","PT20S"); w.WriteEndElement(); w.WriteEndElement();
